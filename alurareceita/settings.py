...
SECRET_KEY = 'django-insecure-7y1!y(&%5^uv+b%$%gvvrq39m+xl2tmn)+qn6&o@!kt^xw_g_='
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'alurareceita/static') # os arquivos estáticos estão no projeto
]
